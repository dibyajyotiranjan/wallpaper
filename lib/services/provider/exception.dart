...
class BadRequestException extends Myexception{
  BadRequestException(String msg):super(heading:"BadRequest Exception",msg:msg);
}

class InvalidInputException extends Myexception{
  InvalidInputException(String msg):super(heading:"InvalidInput Exception",msg:msg);
}
